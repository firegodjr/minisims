...
function load_json(path) {
    var promise = make_request(OBJECTS_PATH + path).then(function (req) {
...
function load_from_manifest(path, callback, names) {
    return __awaiter(this, void 0, void 0, function () {
        var man, obj_arr, i;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, load_json(path + "manifest.json")];
                case 1:
                    man = _a.sent();
                    obj_arr = [];
                    ...
                    return [4 /*yield*/, Promise.all(obj_arr)];
