...
class TileCreator
{
    ...
    {   let tile = new Tile(type, this.colorTable.get(type), 4, this.densityTable.get(type), this.heightTable.get(type), this.variationTable.get(type), this.optimizeTable.get(type), undefined, this.grassColorTable.get(type));
        return tile;
    }
}
